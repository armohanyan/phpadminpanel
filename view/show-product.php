...
<body>
    <?php if ($_SESSION['user']['id'] == 1) { ?>
        ...
        <header class="page-header">
            <nav>
                <a href="./admin/index.php" aria-label="forecastr logo" class="logo">
                    Admin Dashboard
                </a>
                ...
                <ul class="admin-menu">
                    ...
                    <li>
                        <a href="./admin/create-product.php">
                                        ...
                                        <div class="col-md-12">
                                            <form action="../controllers/ProductController.php" method="post">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <button class="btn btn-success btn-lg" type="submit" name="submitReview" value="<?php echo $_GET['id'] ?>">Save</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
