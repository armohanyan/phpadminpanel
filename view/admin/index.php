    ...
    <section class="d-flex">
        <div class="col-sm-12 col-lg-4">
            <div class="card card-hover bg-red">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="mr-4 bg-red">
                            <span>Users Count</span>
                            <h4 class="mb-0"><?php echo $countOfUsersProductsReviews['countUsers'] ?></h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-lg-4">
            <div class="card card-hover bg-blue">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="mr-4">
                            <span>Products Count</span>
                            <h4 class="mb-0"><?php echo $countOfUsersProductsReviews['countProducts'] ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="mr-4">
                            ...
                            <h4 class="mb-0"><?php echo $countOfUsersProductsReviews['countReviews'] ?></h4>
                        </div>
                    </div>
                </div>
            </div>
